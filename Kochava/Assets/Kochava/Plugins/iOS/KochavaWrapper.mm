...
extern "C" {
	...
	void iOSNativeStart(const char *inputParameters)
	{
        ...
        dispatch_once(&wrapper_product_dispatch_once_t, ^{
            ...
            KVAProduct *wrapperProduct = [KVAProduct productWithAPIVersionString:@"3"/*[a]*/ buildDateString:wrapperBuildDateString bundleIdentifierString:nil/*[b]*/ compilerFlagNameStringArray:nil compilerFlagPredicateSubstitutionVariablesDictionary:nil moduleNameString: @"KochavaUnity" nameString:wrapperNameString/*[c]*/ organizationNameString:@"Kochava" reverseDomainNameString:@"com.kochava.KochavaUnity" versionString:wrapperVersionString/*[d]*/];
